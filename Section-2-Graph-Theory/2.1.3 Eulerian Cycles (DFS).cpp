...
cycle will be repeated as the last element of the vector. Both functions require
all values of their input adj[] vectors to be between 0 and MAXN - 1, inclusive.
