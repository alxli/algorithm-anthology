...
\begin{compactitem}
  ...
  \item \inlinecode{angle\_between(a1, b1, a2, b2)} returns the smaller angle in radians between two lines \inlinecode{a1}$x$ + \inlinecode{b1}$y$ + \inlinecode{c1} = 0 and \inlinecode{a2}$x$ + \inlinecode{b2}$y$ + \inlinecode{c2} = 0, limited to $[0, \pi / 2]$.
...
\begin{compactitem}
  \item \inlinecode{line\_intersection(a1, b1, c1, a2, b2, c2, \&p)} intersects lines \inlinecode{a1}$x$ + \inlinecode{b1}$y$ + \inlinecode{c1} = 0 and \inlinecode{a2}x + \inlinecode{b2}y + \inlinecode{c2} = 0, returning $-1$ (parallel), 0 (one point, stored in \inlinecode{p}), or 1 (identical).
  ...
  \item \inlinecode{closest\_point(a, b, c, p)} returns the closest point on line \inlinecode{a}$x$ + \inlinecode{b}$y$ + \inlinecode{c} = 0 to $p$.
\end{compactitem}
