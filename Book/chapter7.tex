...
\subsection{Point}
A 2D real-valued point class supporting epsilon comparisons. Operations include element-wise arithmetic, \inlinecode{norm()}, \inlinecode{arg()}, \inlinecode{dot()}, \inlinecode{cross()}, \inlinecode{proj()}, \inlinecode{normalize()}, \inlinecode{rotate90()}, \inlinecode{rotate180()}, \inlinecode{rotate270()}, \inlinecode{rotateCW()}, \inlinecode{rotateCCW()}, and \inlinecode{reflect()}. The cardinal rotations (\inlinecode{rotate90/180/270}) use the counter-clockwise convention; \inlinecode{rotate270()} is equivalent to a 90-degree clockwise rotation. See also \inlinecode{std::complex}.
