...
\begin{compactitem}
  ...
  \item $O(\log n)$ auxiliary stack space for operations that call \inlinecode{find\_root()}.
...
\begin{compactitem}
  ...
  \item $O(\log n)$ worst-case per call to \inlinecode{find\_root()}, \inlinecode{is\_united()}, and \inlinecode{unite()}.
