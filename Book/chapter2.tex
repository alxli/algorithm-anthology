...
\begin{compactitem}
  ...
  \item \inlinecode{query(x1, y1, x2, y2, f)} calls the function \inlinecode{f(i, x, y)} on each point whose $x$-coordinate is in $[{\inlinecodemath{x1}}, {\inlinecodemath{x2}}]$ and whose $y$-coordinate is in $[{\inlinecodemath{y1}}, {\inlinecodemath{y2}}]$. The first argument to \inlinecode{f} is the 0-based index of the point in the original range given to the constructor.
\end{compactitem}
