...
Overflow warning: For both integer searches, \inlinecode{hi - lo} must be representable by \inlinecode{Int}. For example, [INT\_MIN, INT\_MAX) will overflow if passed as signed 32-bit integer boundaries.
