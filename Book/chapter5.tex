...
\textbf{Time Complexity}: $O(2^{n})$ pivots in the worst case, where $n$ is the number of unknowns, although simplex is typically much faster in practice.
