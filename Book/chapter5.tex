...
Coefficient vectors must be nonempty and omit trailing zero coefficients. \inlinecode{find\_one\_root()} requires a polynomial of degree at least one.
...
Root-finding inputs must contain at least one nonzero coefficient; trailing near-zero coefficients are discarded. \inlinecode{eval\_with\_derivative()} requires a nonempty coefficient vector.
