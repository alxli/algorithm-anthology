...
\begin{compactitem}
  \item \inlinecode{partition\_three\_way(lo, hi, pivot)} rearranges $[{\inlinecodemath{lo}}, {\inlinecodemath{hi}})$ in-place and returns iterators $({\inlinecodemath{mid_lo}}, {\inlinecodemath{mid_hi}})$, where $[{\inlinecodemath{lo}}, {\inlinecodemath{mid_lo}})$ is less than \inlinecode{pivot}, $[{\inlinecodemath{mid_lo}}, {\inlinecodemath{mid_hi}})$ is equal to \inlinecode{pivot}, and $[{\inlinecodemath{mid_hi}}, {\inlinecodemath{hi}})$ is greater than \inlinecode{pivot}.
