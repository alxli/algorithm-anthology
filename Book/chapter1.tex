...
\begin{compactitem}
  \item \inlinecode{frequent\_candidates(lo, hi, k)} returns a hash table of candidate values to their residual counters. Use \inlinecode{k = 2} for the Boyer-Moore majority-candidate special case.
\end{compactitem}
