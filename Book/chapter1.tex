...
\section{\texorpdfstring{Miscellaneous Problems}{1.6 Miscellaneous Problems}}
...
\begin{compactitem}
  \item \inlinecode{josephus(n, k)} returns the zero-based label of the survivor, where \inlinecode{n} and \inlinecode{k} must be positive.
