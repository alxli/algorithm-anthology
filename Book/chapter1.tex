...
\begin{compactitem}
  ...
  \item \inlinecode{floor\_pow2(x)} and \inlinecode{ceil\_pow2(x)} return the largest power of two that is \inlinecode{\textless{}= x} and the smallest that is \inlinecode{\textgreater{}= x}, respectively (with \inlinecode{x \textgreater{} 0}).
