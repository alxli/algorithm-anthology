...
By default, each sequence value is cast to \inlinecode{uint64\_t} and mixed. For non-integer element types, pass a custom value hasher that maps each element to a stable nonzero value in $[1, {\inlinecodemath{HASH_MOD}})$.
