...
\textbf{Space Complexity}:
\begin{compactitem}
  \item $O(n)$ auxiliary for storage of the suffix and LCP arrays.
...
\textbf{Space Complexity}:
\begin{compactitem}
  \item $O(m)$ auxiliary for \inlinecode{byte\_frequencies()}.
