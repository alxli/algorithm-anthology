...
\begin{compactitem}
  \item \inlinecode{monotone\_queue\textless{}Compare\textgreater{}()} constructs an empty queue. Use \inlinecode{std::less\textless{}T\textgreater{}} for minimum queries and \inlinecode{std::greater\textless{}T\textgreater{}} for maximum queries.
...
\begin{compactitem}
  ...
  \item If \inlinecode{opt} is not \inlinecode{NULL}, it is filled with the chosen split points.
\end{compactitem}
...
\begin{compactitem}
  \item \inlinecode{hull\_optimizer(query\_max)} constructs an empty hull. By default, \inlinecode{query(x)} minimizes; if \inlinecode{query\_max} is true, \inlinecode{query(x)} maximizes.
...
\begin{compactitem}
  \item \inlinecode{li\_chao\_tree(lo, hi)} constructs an empty tree over integer domain \inlinecode{[lo, hi]}.
