...
Literals must be nonnegative decimal integers, although unary signs may precede them. The input must be valid and contain no whitespace. Division truncates toward zero, every divisor must be nonzero, and all intermediate results must fit in \inlinecode{int}.
...
\end{lstlisting}
\subsection{Postfix Conversion and Evaluation}
