...
\begin{compactitem}
  ...
  \item $O(n \cdot k)$ expected per call to \inlinecode{conditional\_entropy(s, k)}, for hashing the context of each position.
\end{compactitem}
...
\begin{compactitem}
  ...
  \item $O(n \cdot k)$ auxiliary for \inlinecode{conditional\_entropy(s, k)}, since at most $n$ distinct contexts are stored.
