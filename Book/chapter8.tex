...
\begin{compactitem}
  ...
  \item \inlinecode{clmp(x, a, b)} returns \inlinecode{x} clamped into the interval $[{\inlinecodemath{a}}, {\inlinecodemath{b}}]$. This is not needed on C++17 and later, where \inlinecode{std::clamp()} is available.
