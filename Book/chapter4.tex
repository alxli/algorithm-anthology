...
\begin{compactitem}
  \item \inlinecode{ford\_fulkerson()} uses global \inlinecode{source} and \inlinecode{sink}, modifies the global residual capacity matrix \inlinecode{cap}, and returns maximum flow. Nodes are numbered $[0, {\inlinecodemath{n}})$, where \inlinecode{n} is \inlinecode{cap.size()}.
\end{compactitem}
