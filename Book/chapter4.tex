...
\begin{compactitem}
  ...
  \item \inlinecode{get\_path(dest)} returns the path from \inlinecode{start} to \inlinecode{dest}, or an empty vector if \inlinecode{dest} is unreachable, only after a successful call to \inlinecode{bellman\_ford()}. Otherwise, if the latest call finds a reachable negative-weight cycle, the shortest paths will be undefined.
\end{compactitem}
...
\begin{compactitem}
  ...
  \item \inlinecode{get\_path(start, dest)} returns the shortest path from \inlinecode{start} to \inlinecode{dest}, or an empty vector if \inlinecode{dest} is unreachable from \inlinecode{start}, provided the most recent call to \inlinecode{floyd\_warshall()} returned true.
\end{compactitem}
...
\begin{compactitem}
  ...
  \item \inlinecode{get\_path(start, dest)} returns the shortest path from \inlinecode{start} to \inlinecode{dest}, or an empty vector if \inlinecode{dest} is unreachable from \inlinecode{start}, provided the most recent call to \inlinecode{johnson\_all\_pairs()} returned true.
\end{compactitem}
