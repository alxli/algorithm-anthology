...
\begin{compactitem}
  ...
  \item \inlinecode{get\_path(dest)} returns the path from \inlinecode{start} to \inlinecode{dest}, or an empty vector if \inlinecode{dest} is unreachable, after the latest successful call to \inlinecode{bellman\_ford()}.
\end{compactitem}
...
\begin{compactitem}
  ...
  \item \inlinecode{get\_path(start, dest)} returns the shortest path from \inlinecode{start} to \inlinecode{dest}, or an empty vector if \inlinecode{dest} is unreachable from \inlinecode{start}, after the latest successful call to \inlinecode{floyd\_warshall()}.
\end{compactitem}
...
\begin{compactitem}
  ...
  \item \inlinecode{get\_path(start, dest)} returns the shortest path from \inlinecode{start} to \inlinecode{dest}, or an empty vector if \inlinecode{dest} is unreachable from \inlinecode{start}, after the latest successful call to \inlinecode{johnson\_all\_pairs()}.
\end{compactitem}
