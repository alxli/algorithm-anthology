...
\begin{compactitem}
  ...
  \item $O(nmk + n)$ expected per call to \inlinecode{eval(s)}, where $n$ is the distance between \inlinecode{lo} and \inlinecode{hi}, and $m$ and $k$ are as defined previous.
\end{compactitem}
