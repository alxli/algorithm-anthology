...
functions, which determines the change made to tree values. These must satisfy:
...
The default code below defines updates that "set" the chosen edge or node to a
