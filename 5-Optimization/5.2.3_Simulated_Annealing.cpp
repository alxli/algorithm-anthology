...
- `anneal_min(f, x0, y0, best_x = nullptr, best_y = nullptr)` returns a small value found by the
  randomized search starting from $(`x0`, `y0`)$. If the optional pointers `best_x` and `best_y` are
