...
Given a continuous function `f(x, y)` to `double` and a (possibly arbitrary) initial guess (`x0`,
`y0`), return a potential global minimum found through hill-climbing. Optionally, two `double`
